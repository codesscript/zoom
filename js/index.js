...
function websdkready() {
  ...
  var API_SECRET = "B7p3dhFTYrLXdwTfJipACMJxhNBYItDm0vxJ";
   ...
   document.getElementById("clear_all").addEventListener("click", function (e) {
    ...
    window.location.href = "file:///C:/Users/hp/New%20folder/CDN_2nd/index.html";
  });
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "file:///C:/Users/hp/New%20folder/CDN_2nd/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
